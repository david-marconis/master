...
\note{Føler at denne delen er litt tynn. Hvordan kan jeg fylle den ut bedre? skal jeg nevne ting fra tabellen/ på hvilken måte kan jeg nevne ting fra tabellen? Litt input på selve tabellen hadde også vært fint.}
...
\section{Analysis}
\note{Trenger litt hjelp med denne delen, er ikke helt sikker på hvordan jeg skal analysere resultatene. Skal jeg bruke noe slags fancy matematikk og statistisk analyse? Skal jeg diskutere spørsmålene hver for seg? burde jeg kanskje dele det opp inn i de forskjellige gameflow kategoriene(concentration, challenge, etc.). Kanskje ha en underkaputtel for kjønnsforskjeller?}