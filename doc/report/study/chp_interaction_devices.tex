...
\note{Skrive noe om motivasjonen til å ha med interaction devices.}
% se på forskjellige interaction devices for å se hva som kan brukes.
...
% \gls{nes}, gamepad, d-pad, why it was successful % cite evolution
