...
\hfigure{atari2600}{The joystick used for the Atari 2600}{1}
...
\hfigure{gamepads}{The gamepads for four generations of Nintendo consoles. NES (top left), SNES (top right), N64 (bottom left), and GameCube (bottom right)}{1}
...
\hfigure{kbam}{Keyboard and Mouse}{1}
...
\hfigure{psmove}{PlayStation Move and PlayStation Eye}{1}
% pros
% cons
...
\hfigure{wheel}{Pedals and steering wheel with buttons for navigating menus.}{0.7}
...
\hfigure{duckhunt}{Screenshot from Duck Hunt}{1}
% Duck hunt, wii
...
\hfigure{rockband}{Instruments from the Rock Band franchise}{1}
