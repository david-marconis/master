...
%ønsker å gi litt bakgrunn for spillmedie og hvordan teknologier kom til, utvikling.


\note{Hvordan skal jeg relatere dette til oppgaven? hvorfor har jeg dette med?}

\section{Early Video Games}
\note{Tenkte å ha en kjapp oppsumering fra 1950-2000 her. Ikke like detaljert som tidligere.}
...
\note{Binde sammen hvorfor ting ble sett på osv.}
